...
; This code produces almost binaries almost byte-to-byte identical to
; tinkerer's assembler by Scot W. Stevenson and was created for
; compatibility testing purposes

		.cpu "65816"
		* = $8000    ; start of code to save to built-in RAM
